...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../ultrasonic_vga_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is ultrasonic_vga_system
SOPC_NAME := ultrasonic_vga_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80c1010
SOPC_SYSID_FLAG += --sidp=0x80c1010
ELF_PATCH_FLAG  += --sidp 0x80c1010

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1747469262
SOPC_SYSID_FLAG += --timestamp=1747469262
ELF_PATCH_FLAG  += --timestamp 1747469262

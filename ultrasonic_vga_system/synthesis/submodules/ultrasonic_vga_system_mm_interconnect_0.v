// ultrasonic_vga_system_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module ultrasonic_vga_system_mm_interconnect_0 (
	...
	wire  [103:0] rsp_mux_src_data;                                                                // rsp_mux:src_data -> nios2_cpu_data_master_agent:rp_data
	...
	wire  [103:0] rsp_mux_001_src_data;                                                            // rsp_mux_001:src_data -> nios2_cpu_instruction_master_agent:rp_data
	...
	wire  [104:0] vga_ip_0_avalon_slave_0_agent_rf_source_data;                                    // VGA_IP_0_avalon_slave_0_agent:rf_source_data -> VGA_IP_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [104:0] vga_ip_0_avalon_slave_0_agent_rsp_fifo_out_data;                                 // VGA_IP_0_avalon_slave_0_agent_rsp_fifo:out_data -> VGA_IP_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> VGA_IP_0_avalon_slave_0_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                           // VGA_IP_0_avalon_slave_0_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> VGA_IP_0_avalon_slave_0_agent:cp_channel
	...
	wire  [103:0] cmd_mux_003_src_data;                                                            // cmd_mux_003:src_data -> nios2_cpu_debug_mem_slave_agent:cp_data
	...
	wire  [103:0] cmd_mux_005_src_data;                                                            // cmd_mux_005:src_data -> sram_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                           // sram_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                         // cmd_mux_005:src_channel -> sram_s1_agent:cp_channel
	...
	wire  [103:0] vga_ip_0_avalon_slave_0_agent_rp_data;                                           // VGA_IP_0_avalon_slave_0_agent:rp_data -> router_003:sink_data
	...
	wire  [103:0] nios2_cpu_debug_mem_slave_agent_rp_data;                                         // nios2_cpu_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	ultrasonic_vga_system_mm_interconnect_0_router router (
	...
	ultrasonic_vga_system_mm_interconnect_0_router_001 router_001 (
	...
	ultrasonic_vga_system_mm_interconnect_0_router_002 router_002 (
	...
	ultrasonic_vga_system_mm_interconnect_0_router_002 router_003 (
	...
	ultrasonic_vga_system_mm_interconnect_0_router_002 router_004 (
	...
	ultrasonic_vga_system_mm_interconnect_0_router_005 router_005 (
	...
	ultrasonic_vga_system_mm_interconnect_0_router_002 router_006 (
	...
	ultrasonic_vga_system_mm_interconnect_0_router_005 router_007 (
	...
	ultrasonic_vga_system_mm_interconnect_0_router_008 router_008 (
	...
	ultrasonic_vga_system_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (altpll_0_c0_clk),                             //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (altpll_0_c0_clk),                             //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (altpll_0_c0_clk),                             //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (altpll_0_c0_clk),                             //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (altpll_0_c0_clk),                             //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (altpll_0_c0_clk),                             //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                              //       clk.clk
		.reset               (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (altpll_0_c0_clk),                             //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_cmd_mux_003 cmd_mux_006 (
		.clk                 (altpll_0_c0_clk),                             //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (altpll_0_c0_clk),                             //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (altpll_0_c0_clk),                             //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (altpll_0_c0_clk),                             //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (altpll_0_c0_clk),                             //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (altpll_0_c0_clk),                             //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_rsp_demux_003 rsp_demux_006 (
		.clk                (altpll_0_c0_clk),                                         //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (altpll_0_c0_clk),                             //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (altpll_0_c0_clk),                             //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ultrasonic_vga_system_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	ultrasonic_vga_system_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
